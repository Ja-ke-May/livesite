      ...
      {state.liveUserId && (
        <div>
         ...
         {!state.liveUserId && !state.isCameraOn && upNext && (
          <div>
        <div className="absolute inset-0 flex flex-col text-center items-center justify-center bg-transparent text-white text-sm md:text-md xl:text-lg p-2 rounded">
